...
1. Parse the query
1. **Check the wiki first** (fast path)
1. Find seed nodes in the graph
1. Expand the graph via BFS
1. Prune noisy nodes
1. Build the subgraph with provenance
1. Return structured context
...
- Prioritize:
  ...
  1. Nodes at depth 1
  1. Nodes at depth 2 (as space allows)
