...
1. Merge synonymous types using the mapping table below
...
1. Convert to **lowercase**
1. Strip whitespace
1. Use verb phrases in **present tense** (e.g., "causes", "contains", "uses")
1. Merge synonyms using the mapping table below
...
1. Use the **canonical** type/relation names when creating nodes and edges in the graph.
