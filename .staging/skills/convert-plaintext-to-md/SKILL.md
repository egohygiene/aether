...
1. **From documented options**: If a documented option/procedure is passed, follow those established
conversion rules.
1. **From reference file**: Use another markdown file (that was previously converted from text format)
