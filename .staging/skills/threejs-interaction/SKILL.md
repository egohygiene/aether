...
1. **Use layers**: Filter raycast targets
1. **Simple collision meshes**: Use invisible simpler geometry for raycasting
1. **Disable controls when not needed**: `controls.enabled = false`
1. **Batch updates**: Group interaction checks
