...
1. **Load progressively**: Show placeholders while loading
1. **Lazy load**: Only load what's needed
1. **Use CDN**: Faster asset delivery
1. **Enable cache**: `THREE.Cache.enabled = true`
