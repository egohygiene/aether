...
1. Project Overview
1. Concept / Product Description
1. Tech Stack
1. Architecture (ASCII diagram)
1. Key Files Map
1. Team Roles
1. Sprint Status (updated every sprint)
1. Current State (rewritten every sprint)
1. Security Rules
1. How to Run Locally
1. How to Deploy
1. **Cross-Chat Handoff Protocol** — how context survives between chats
1. **Bug & Fix Tracking** — GitHub Issues as single source of truth
1. **Multi-Repo Setup** — separate clones, branch strategy, merge rules
...
1. Update `PROJECT_BRIEF.md` sections 7+8
1. Write `docs/sprint-N/done.md`
