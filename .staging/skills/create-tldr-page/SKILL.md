...
1. **Extract key examples** - Identify the most common and useful command patterns
1. **Follow tldr format strictly** - Use the template structure with proper markdown formatting
1. **Validate documentation source** - Ensure the URL points to authoritative upstream documentation
