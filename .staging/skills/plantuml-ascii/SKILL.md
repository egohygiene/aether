...
1. **Short labels**: Long text breaks ASCII alignment
1. **Use Unicode (`-utxt`)**: Better visual quality with box-drawing chars
1. **Test before sharing**: Verify in terminal with fixed-width font
1. **Consider alternatives**: For complex diagrams, use Mermaid.js or graphviz
