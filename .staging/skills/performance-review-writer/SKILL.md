...
1. **Subject** — who is the review about? (for peer/upward: name and role)
1. **Review period** — what time range does this cover? (e.g., Jan–Dec 2025, last 6 months)
...
1. Highlight any sections marked `[NEEDS DETAIL]` where more specifics would strengthen the review
1. Iterate on edits as the user requests
1. Save the final draft to `outputs/<year>/<month>/` with a descriptive filename (e.g., `2025-review-self-assessment.md` or `2025-peer-review-alex-chen.md`)
