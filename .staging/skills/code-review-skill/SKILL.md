...
1. Check PR size (>400 lines? Ask to split)
1. Review CI/CD status (tests passing?)
1. Understand the business requirement
1. Note any relevant architectural decisions
...
1. **Testing Strategy** - Are there tests covering edge cases?
