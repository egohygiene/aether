...
1. Writes a clear `ERROR: aborted_missing_docs — reference_docs/ empty and --require-docs set` block to `quality/PROGRESS.md`.
1. Aborts before any LLM work (exit non-zero, same as a gate-fail).
