...
1. **Avoid conditionals**: Use mix/step instead of if/else
1. **Precalculate**: Move calculations to JS when possible
1. **Use textures**: For complex functions, use lookup tables
1. **Limit overdraw**: Avoid transparent objects when possible
