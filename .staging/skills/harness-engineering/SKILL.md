...
1. Write target-specific agent instructions.
1. Add enforceable checks for high-value rules.
1. Record failure memory for high-risk or recurring failures.
1. Add drift checks for guidance that can silently become stale.
1. Report the adoption with evidence, assumptions, and follow-up.
