...
1. **Merge static meshes**: Reduce draw calls with `mergeGeometries`
1. **Use InstancedMesh**: For many identical objects
1. **Choose appropriate segment counts**: More segments = smoother but slower
1. **Dispose unused geometry**: `geometry.dispose()`
