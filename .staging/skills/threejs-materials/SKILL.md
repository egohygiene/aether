...
1. **Avoid transparent when possible**: Transparent materials require sorting
1. **Use alphaTest instead of transparency**: When applicable, faster
1. **Choose simpler materials**: Basic > Lambert > Phong > Standard > Physical
1. **Limit active lights**: Each light adds shader complexity
