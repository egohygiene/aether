...
1. [Two Types of Scroll Animation](#two-types-of-scroll-animation)
1. [useScroll — Options Reference](#usescroll--options-reference)
1. [useTransform — Full Reference](#usetransform--full-reference)
1. [useSpring for Smoothing](#usespring-for-smoothing)
1. [Recipes with Copilot Prompts](#recipes-with-copilot-prompts)
   - Scroll progress bar
   ...
   - Staggered card grid
   - 3D tilt on scroll
1. [Variants Pattern for Stagger](#variants-pattern-for-stagger)
1. [Motion Value Events](#motion-value-events)
1. [Next.js & App Router Notes](#nextjs--app-router-notes)
1. [Accessibility](#accessibility)
1. [Common Copilot Pitfalls](#common-copilot-pitfalls)
...
1. Import them into Server Components — they'll be client-rendered automatically
1. Use `AnimatePresence` at the layout level for page transitions
