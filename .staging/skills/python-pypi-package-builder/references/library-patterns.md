...
1. [Type Hints Best Practices](#2-type-hints-best-practices)
1. [Core Class Design](#3-core-class-design)
1. [Factory / Builder Pattern](#4-factory--builder-pattern)
1. [Configuration Pattern](#5-configuration-pattern)
1. [`__init__.py` — explicit public API](#6-__init__py--explicit-public-api)
1. [Optional Backends (Plugin Pattern)](#7-optional-backends-plugin-pattern)
