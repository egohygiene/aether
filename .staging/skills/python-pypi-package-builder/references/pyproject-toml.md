...
1. [hatchling (modern, zero-config)](#2-hatchling-modern-zero-config)
1. [flit (minimal, version from `__version__`)](#3-flit-minimal-version-from-__version__)
1. [poetry (integrated dep manager)](#4-poetry-integrated-dep-manager)
1. [Versioning Strategy — PEP 440, semver, dep specifiers](#5-versioning-strategy)
1. [setuptools_scm — dynamic version from git tags](#6-dynamic-versioning-with-setuptools_scm)
1. [setup.py shim for legacy editable installs](#7-setuppy-shim)
1. [PEP 561 typed package (py.typed)](#8-typed-package-pep-561)
