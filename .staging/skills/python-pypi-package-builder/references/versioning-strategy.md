...
1. [Semantic Versioning (SemVer)](#2-semantic-versioning-semver)
1. [Pre-release Identifiers](#3-pre-release-identifiers)
1. [Versioning Decision Engine](#4-versioning-decision-engine)
1. [Dynamic Versioning — setuptools_scm (Recommended)](#5-dynamic-versioning--setuptools_scm-recommended)
1. [Hatchling with hatch-vcs Plugin](#6-hatchling-with-hatch-vcs-plugin)
1. [Static Versioning — flit](#7-static-versioning--flit)
1. [Static Versioning — hatchling manual](#8-static-versioning--hatchling-manual)
1. [DO NOT Hardcode Version (except flit)](#9-do-not-hardcode-version-except-flit)
1. [Dependency Version Specifiers](#10-dependency-version-specifiers)
1. [PyPA Release Commands](#11-pypa-release-commands)
