...
1. [Config Layer (Settings Dataclass)](#2-config-layer-settings-dataclass)
1. [Transport Layer (HTTP Client Abstraction)](#3-transport-layer-http-client-abstraction)
1. [CLI Support](#4-cli-support)
1. [Backend Injection in Core Client](#5-backend-injection-in-core-client)
1. [Decision Rules](#6-decision-rules)
