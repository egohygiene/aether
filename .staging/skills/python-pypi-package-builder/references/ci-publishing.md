...
1. [ci.yml — lint, type-check, test matrix](#2-ciyml)
1. [publish.yml — triggered on version tags](#3-publishyml)
1. [PyPI Trusted Publishing (no API tokens)](#4-pypi-trusted-publishing)
1. [Manual publish fallback](#5-manual-publish-fallback)
1. [Release checklist](#6-release-checklist)
1. [Verify py.typed ships in the wheel](#7-verify-pytyped-ships-in-the-wheel)
1. [Semver change-type guide](#8-semver-change-type-guide)
...
1. Go to **Account → Publishing → Add a new pending publisher**
1. Fill in:
