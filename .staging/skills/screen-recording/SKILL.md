...
1. **Hero message gets the biggest font** — 64pt+ for the main takeaway, 38pt for details
1. **GIF palette does NOT kill gradients** — 20 distinct alpha steps survive 256-color palette
1. **10fps minimum** for typing/interaction — lower looks stuttery
1. **Build iteratively** — get the frame sequence right first, add annotations second, tune timing last
