...
1. **Use baked lighting**: For static scenes, bake to textures
1. **Smaller shadow maps**: 512-1024 often sufficient
1. **Tight shadow frustums**: Only cover needed area
1. **Disable unused shadows**: Not all lights need shadows
1. **Use light layers**: Exclude objects from certain lights
