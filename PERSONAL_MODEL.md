...
id: aether-personal-model
title: Aether Personal Model
...
Aether is designed for and operated by people even when it is primarily a library or automation surface. This document makes its limited human assumptions explicit; it is not a persona catalog, diagnosis, identity model, or prediction engine.
...
- skill authors
- maintainers
- consumers installing governed AI capabilities
