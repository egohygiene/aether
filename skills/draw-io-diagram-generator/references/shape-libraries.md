...
1. Click the `+` icon in the shape panel (left sidebar) →`Search Shapes` or `More Shapes`
1. Check the library you want to activate
1. Shapes appear in the panel for drag-and-drop
