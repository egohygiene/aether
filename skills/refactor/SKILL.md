...
1. **Small steps** - Make tiny changes, test after each
1. **Version control is your friend** - Commit before and after each safe state
1. **Tests are essential** - Without tests, you're not refactoring, you're editing
