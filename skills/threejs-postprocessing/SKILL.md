...
1. **Lower resolution**: Use smaller render targets for blur passes
1. **Disable unused effects**: Toggle passes on/off
1. **Use FXAA over MSAA**: Less expensive anti-aliasing
1. **Profile with DevTools**: Check GPU usage
