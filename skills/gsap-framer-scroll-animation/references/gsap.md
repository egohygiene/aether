...
1. [ScrollTrigger Config Reference](#scrolltrigger-config-reference)
1. [Start / End Syntax Decoded](#start--end-syntax-decoded)
1. [toggleActions Values](#toggleactions-values)
1. [Recipes with Copilot Prompts](#recipes-with-copilot-prompts)
   ...
   - ScrollSmoother
   - Scroll counter
1. [React Integration (useGSAP)](#react-integration-usegsap)
1. [Lenis Smooth Scroll](#lenis-smooth-scroll)
1. [Responsive with matchMedia](#responsive-with-matchmedia)
1. [Accessibility](#accessibility)
1. [Performance & Cleanup](#performance--cleanup)
