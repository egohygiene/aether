...
1. **Purpose** — what is the email about? (proposal, follow-up, technical guidance, introduction, status update, etc.)
1. **Key points** — what needs to be communicated?
1. **Relationship context** — use WorkIQ to check prior email history with the recipient if available
...
1. Apply those patterns to the draft
...
1. Apply edits as the user requests — iterate until satisfied
1. Save the final draft to `outputs/<year>/<month>/` with a descriptive filename (e.g., `2026-03-26-email-acme-followup.md`)
