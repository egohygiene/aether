...
1. **Project Type**: (e.g., web app, API, mobile app, desktop app, library, etc.)
1. **Additional Technologies**: (e.g., database, cloud provider, testing frameworks, etc.)
1. **Development Style**: (strict standards, flexible, specific patterns)
1. **GitHub Actions / Coding Agent**: Does the project use GitHub Actions? (yes/no — determines whether to generate `copilot-setup-steps.yml`)
...
1. **Fetch specific agents from awesome-copilot docs**: <https://github.com/github/awesome-copilot/blob/main/docs/README.agents.md>
1. **Fetch specific skills from awesome-copilot docs**: <https://github.com/github/awesome-copilot/blob/main/docs/README.skills.md>
...
1. **Look for general matches** (e.g., frontend agents, testing skills, review workflows)
1. **Check the docs and relevant directories directly** for related files
1. **Prefer repo-native examples** over inventing new formats
...
1. **Research awesome-copilot patterns**:
...
1. **Create language-specific instruction files** using awesome-copilot references with attribution
1. **Generate reusable skills** tailored to project needs
1. **Set up specialized agents**, fetching from awesome-copilot where applicable (especially for expert engineer agents matching the tech stack)
1. **Create the GitHub Actions workflow for Coding Agent** (`copilot-setup-steps.yml`) — skip if user does not use GitHub Actions
1. **Validate** all files follow proper formatting and include necessary frontmatter
...
1. **Usage examples** - How to use each skill and agent
