...
1. [Docstrings — Google style](#2-docstrings--google-style)
1. [CONTRIBUTING.md template](#3-contributingmd)
1. [SECURITY.md template](#4-securitymd)
1. [GitHub Issue Templates](#5-github-issue-templates)
1. [PR Checklist](#6-pr-checklist)
1. [Anti-patterns to avoid](#7-anti-patterns-to-avoid)
1. [Master Release Checklist](#8-master-release-checklist)
