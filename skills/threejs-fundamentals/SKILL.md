...
1. **Frustum culling**: Enabled by default, ensure bounding boxes are correct
1. **LOD (Level of Detail)**: Use `THREE.LOD` for distance-based mesh switching
1. **Object pooling**: Reuse objects instead of creating/destroying
1. **Avoid `getWorldPosition` in loops**: Cache results
