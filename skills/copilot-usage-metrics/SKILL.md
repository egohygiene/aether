...
1. Ask for the org name or enterprise slug if not provided.
1. Determine if they want **aggregated** metrics or **per-user** metrics.
1. Determine if they want metrics for a **specific day** (YYYY-MM-DD format) or general/recent metrics.
1. Run the appropriate script from this skill's directory.
