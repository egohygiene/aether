...
1. **Compress textures**: KTX2/Basis for web delivery
1. **Use texture atlases**: Reduce texture switches
1. **Enable mipmaps**: For distant objects
1. **Limit texture size**: 2048 usually sufficient for web
1. **Reuse textures**: Same texture = better batching
